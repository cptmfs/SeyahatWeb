...
(function() {
	...
	// //thinkweb2.com/projects/prototype/detecting-event-support-without-browser-sniffing/
	var eventSupported = function( eventName ) {
		...
		// to go haywire. See: //developer.mozilla.org/en/Security/CSP
		if ( !el.attachEvent ) {
			return true;
		}
...
jQuery.each({
	...
	jQuery.fn[ name ] = function( until, selector ) {
		var ret = jQuery.map( this, fn, until ),
			...
			// //github.com/jquery/jquery/commit/52a0238
			// to work around a bug in Chrome 10 (Dev) and should be removed when the bug is fixed.
			// //code.google.com/p/v8/issues/detail?id=1050
		...
		if ( !s.crossDomain || jQuery.support.cors ) {
			...
			return {
				send: function( headers, complete ) {
					...
					// (see why at //trac.dojotoolkit.org/ticket/9486)
