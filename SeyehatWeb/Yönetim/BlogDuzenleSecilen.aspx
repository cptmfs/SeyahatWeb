<%@ Page Title="" Language="C#" MasterPageFile="~/Yönetim/Admin.Master" AutoEventWireup="true" CodeBehind="BlogDuzenleSecilen.aspx.cs" Inherits="SeyehatWeb.Yönetim.BlogDuzenleSecilen" %>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <asp:Button ID="resimYukle" CssClass="btn btn-gradient-primary mr-2" runat="server" Text="Resim Yükle" OnClick="resimYukle_Click" />
                ...
                <asp:Button ID="btnGuncelle" CssClass="btn btn-gradient-primary mr-2" runat="server" Text="Güncelle" OnClick="btnGuncelle_Click" />
            </div>
        </div>
    </div>
