...
// based on: //www.php.net/manual/en/function.sha1.php#39492
...
$policy = base64_encode(json_encode(array(
	...
	'conditions' => array(
		...
		// //docs.amazonwebservices.com/AmazonS3/latest/dev/HTTPPOSTFlash.html
...
$(function() {
	$("#uploader").plupload({
		...
		url : '//<?php echo $bucket; ?>.s3.amazonaws.com/',
		max_file_size : '10mb',
